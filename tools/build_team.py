...
def _config_yaml(name: str, tier: str, team: str) -> str:
    effort = "medium" if tier == "fast" else "high"
...
# apply one per tier with `python3 tools/team_models.py {team} --preset balanced` (see
# docs/MODELS.md) or set it directly with `hermes -p {name} model`. Preserved across
