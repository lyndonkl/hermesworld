...
Run `python3 tools/validate.py --selftest` before committing. Zero errors is
the bar. `python3 tools/validate.py --hermes-src ~/.hermes/hermes-agent` also
...
tools/                           validate.py, sync_shared.py, install.sh, publish_mirrors.sh,
                                 convert_claude_skill.py
```
