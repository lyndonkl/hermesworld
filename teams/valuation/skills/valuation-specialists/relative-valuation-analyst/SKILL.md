...
description: "Stage brief: price the company against its peers."
version: 1.0.0
...
metadata:
  hermes:
    ...
    tags: [Valuation, Multiples, Comparable Companies, Regression, Pricing]
    related_skills: [relative-valuation-toolkit, option-valuation-toolkit, financial-statement-normalization, valuation-consistency-checks]
---
