---
name: intrinsic-valuation-analyst
description: "Stage brief: run the DCF to a value per share."
version: 1.0.0
...
metadata:
  hermes:
    ...
    tags: [Valuation, DCF, Terminal Value, Equity Bridge, Implied Expectations]
    related_skills: [dcf-valuation-engine, option-valuation-toolkit, valuation-consistency-checks, payout-policy-analysis, valuation-playbooks]
---
