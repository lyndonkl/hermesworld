...
| [`welch-ai-guide`](packages/welch-ai-guide/) | An interactive tutor for Stephen C. Welch's AI Book repo, guiding users through the math and Python code behind neural networks, and reading output visualizations. | 0 custom skills (pure conversational tutor) |
