...
description: "Stage brief: find the optimal debt ratio and design it."
version: 1.0.0
...
metadata:
  hermes:
    ...
    tags: [Corporate Finance, Capital Structure, Optimal Debt Ratio, Debt Design, Cost of Capital]
    related_skills: [cost-of-capital-toolkit, debt-design, project-investment-analysis, relative-valuation-toolkit, valuation-playbooks]
---
...
- Loaded by the orchestrator in `corporate-finance` and `restructuring` modes, in parallel
  with the payout and investment stages, once the cost of capital is fixed.
- Loaded for optimal debt ratio, excess debt capacity, recapitalization value, debt capacity
  stress tests, rating-constraint cost, debt maturity or debt currency questions, and
