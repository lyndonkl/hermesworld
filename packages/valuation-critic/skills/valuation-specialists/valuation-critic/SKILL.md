---
name: valuation-critic
description: "Stage brief: attack the finished analysis, raise findings."
version: 1.0.0
...
metadata:
  hermes:
    ...
    tags: [Valuation, Red Team, Review, Findings, Consistency]
    related_skills: [valuation-red-team, valuation-consistency-checks, dcf-valuation-engine, financial-statement-normalization, relative-valuation-toolkit, option-valuation-toolkit, cost-of-capital-toolkit, project-investment-analysis, monte-carlo-valuation, valuation-playbooks]
---
...
- Loaded by the orchestrator once gate `G6_valued` has passed and before any verdict or
